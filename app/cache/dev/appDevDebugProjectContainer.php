...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'tucv_db', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/PCV/DemoBundle/Entity'))), 'PCV\\DemoBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PCVDemoBundle' => 'PCV\\DemoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6cfb71728273ea3483b3640bc891197ada9c475bf589ba18a78a34573659dca9');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('PCV\\DemoBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/private/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $h, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($h, '_demo_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '_demo_logout'));
        ...
        $j->setOptions(array('login_path' => '_demo_login', 'default_target_path' => '_private_resume_profile', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.user_db')), 'demo_secured_area', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $h, 'demo_secured_area', $j, $k, array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, '_demo_login', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('contacto@tucv.cl');
        $a->setPassword('N9BQ!J;9UPxb');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('solu10.tuwebdns.net');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('resume', 'visualiza tus datos de forma simple y ordenada. Facilitamos el ingreso de tus datos de forma creativa, entregando una combinación perfecta entre sencillez y modernidad.');
        $instance->addGlobal('project', 'Exhibe al mundo tus creaciones. Incluimos un portafolio donde podrás presentar, detallar y compartir todos los proyectos o trabajos profesionales en que has participado.');
        $instance->addGlobal('cloud', 'Crea tu perfil Profesional y mantenlo en la web, comparte y envía sólo la dirección de tu Resumen, desde el lugar en que te encuentres y cuando quieras.');
        $instance->addGlobal('image', 'Hazte visible y muestrate al mundo tal como eres. Agrega y edita tu imagen de perfil en tu resumen profesional, además podrás añadir imagenes a cada proyecto de tu portafolio.');
        $instance->addGlobal('video', 'Aumenta la probabilidad de encontrar empleo mediante Video Curriculum. Presenta tus conocimientos y aptitudes para que te conozcan a fondo y destacar sobre el resto de candidatos.');
        $instance->addGlobal('email', 'Envía y comparte tu resumen o portafolio con tus amigos, compañeros de trabajo o distintas ofertas de empleo que desees postular, directamente desde "tucv.cl".');
        $instance->addGlobal('search', 'Únete a TuCV y las empresas podrán encontrarte. Ofrecemos una búsqueda avanzada donde podrán conocer, revisar y analizar tu resumen, y contactarte para un futuro empleo.');
        $instance->addGlobal('responsive', 'Te Proporcionamos un diseño Web totalmente adaptable. Disponemos de un diseño optimizado donde podrás visualizar tu resumen sin problema en tu laptop, tablet o móvil.');
        $instance->addGlobal('download', 'Si no te conformas con tener tu curriculum web, puedes descargarlo y tenerlo en formato .PDF. Disponemos de plantillas totalmete gratuitas.');
        $instance->addGlobal('eye', 'Te mantendremos informado sobre la cantidad de visitas que ha tenido tu resumen web a la fecha.');
        $instance->addGlobal('compartir', 'Puedes compartir en redes sociales tu resumen profesional, así te darás a conocer a millones de personas y/o empresas por el mundo.');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PCV/DemoBundle/Resources/views'), 'PCVDemo');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.user_db'), new \Symfony\Component\Security\Core\User\UserChecker(), 'demo_secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'PCV\\DemoBundle\\Entity\\User', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PCVDemoBundle' => 'PCV\\DemoBundle\\PCVDemoBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'tucv_db',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'solu10.tuwebdns.net',
            'mailer_user' => 'contacto@tucv.cl',
            'mailer_password' => 'N9BQ!J;9UPxb',
            'locale' => 'en',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'resume' => 'visualiza tus datos de forma simple y ordenada. Facilitamos el ingreso de tus datos de forma creativa, entregando una combinación perfecta entre sencillez y modernidad.',
            'project' => 'Exhibe al mundo tus creaciones. Incluimos un portafolio donde podrás presentar, detallar y compartir todos los proyectos o trabajos profesionales en que has participado.',
            'cloud' => 'Crea tu perfil Profesional y mantenlo en la web, comparte y envía sólo la dirección de tu Resumen, desde el lugar en que te encuentres y cuando quieras.',
            'image' => 'Hazte visible y muestrate al mundo tal como eres. Agrega y edita tu imagen de perfil en tu resumen profesional, además podrás añadir imagenes a cada proyecto de tu portafolio.',
            'video' => 'Aumenta la probabilidad de encontrar empleo mediante Video Curriculum. Presenta tus conocimientos y aptitudes para que te conozcan a fondo y destacar sobre el resto de candidatos.',
            'email' => 'Envía y comparte tu resumen o portafolio con tus amigos, compañeros de trabajo o distintas ofertas de empleo que desees postular, directamente desde "tucv.cl".',
            'search' => 'Únete a TuCV y las empresas podrán encontrarte. Ofrecemos una búsqueda avanzada donde podrán conocer, revisar y analizar tu resumen, y contactarte para un futuro empleo.',
            'responsive' => 'Te Proporcionamos un diseño Web totalmente adaptable. Disponemos de un diseño optimizado donde podrás visualizar tu resumen sin problema en tu laptop, tablet o móvil.',
            'download' => 'Si no te conformas con tener tu curriculum web, puedes descargarlo y tenerlo en formato .PDF. Disponemos de plantillas totalmete gratuitas.',
            'eye' => 'Te mantendremos informado sobre la cantidad de visitas que ha tenido tu resumen web a la fecha.',
            'compartir' => 'Puedes compartir en redes sociales tu resumen profesional, así te darás a conocer a millones de personas y/o empresas por el mundo.',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'solu10.tuwebdns.net',
            'swiftmailer.mailer.default.transport.smtp.username' => 'contacto@tucv.cl',
            'swiftmailer.mailer.default.transport.smtp.password' => 'N9BQ!J;9UPxb',
